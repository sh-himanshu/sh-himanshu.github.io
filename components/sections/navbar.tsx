    ...
    return (
        <div className="pointer-events-none fixed inset-x-0 top-0 z-50 px-(--page-gutter) pt-4 md:pt-6">
            <nav
                aria-label="Primary"
                className={cn(
                    "pointer-events-auto mx-auto w-fit rounded-full border border-white/10 bg-zinc-900/72 px-2 py-2 shadow-[0_10px_40px_rgba(0,0,0,0.35)] backdrop-blur-xl transition-all duration-300 ease-out md:backdrop-blur-2xl",
                    isScrolled
                        ? "translate-y-0"
                        ...
                        return (
                            <li key={item.id} className="relative z-10">
                                <a
                                    ...
                                    className={cn(
                                        "flex items-center justify-center gap-2 rounded-full px-3 py-2 transition-all duration-200 focus-visible:ring-2 focus-visible:ring-[#68c7ff]/70 focus-visible:ring-offset-2 focus-visible:ring-offset-[#050505] focus-visible:outline-none md:px-4",
                                        isActive
